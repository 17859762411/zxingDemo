package com.android.lvtong.zxingdemo.zbar;
...
import com.android.lvtong.zxingdemo.R;
import com.android.lvtong.zxingdemo.util.CustomUtils;
import com.android.lvtong.zxingdemo.zbar.camera.CameraManager;
import com.android.lvtong.zxingdemo.zbar.decode.MainHandler;
import com.android.lvtong.zxingdemo.zbar.utils.BeepManager;
...
/**
 * Desc: 1:启动一个SurfaceView作为取景预览 2:开启camera,在后台独立线程中完成扫描任务 3:对解码返回的结果进行处理并复制到剪切板 4:释放资源
 *
 * @author 22939
 */
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private int checkPermission(int permissionCode) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            try {
                ...
                Method method = _manager.getClass()
                                        .getDeclaredMethod("noteOp", types);
    ...
    private void displayFrameworkBugMessageAndExit() {
        String per =
                String.format(getString(R.string.permission), getString(R.string.camera), getString(R.string.camera));
    ...
    private void activityResult(String result) {
        if (!isFinishing()) {
            ...
            Toast.makeText(this, "已复制到剪切板", Toast.LENGTH_SHORT)
                 .show();
