 ...
 */
package com.android.lvtong.zxingdemo.zbar.camera;
...
import com.android.lvtong.zxingdemo.zbar.utils.Config;
...
public final class CameraConfigurationManager {
    ...
    public void setDesiredCameraParameters(Camera camera, boolean safeMode) {
        ...
        if (prefs.getBoolean(Config.KEY_INVERT_SCAN, false)) {
            String colorMode =
                    findSettableValue(parameters.getSupportedColorEffects(), Camera.Parameters.EFFECT_NEGATIVE);
            if (colorMode != null) {
